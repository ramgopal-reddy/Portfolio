    ...
    >
      ...
      >
        <div className="text-center mb-4">
          <h2
            className={`text-3xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r ${theme.colors.gradient}`}
          >
            {/* About Me */}
            <DualHighlight first="About" second="Data Understanding" />
          </h2>

          <div
            className="w-24 h-1 mx-auto rounded-full mt-4 bg-gradient-to-r"
            style={{
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 lg:order-1 text-center lg:text-left">
            <div className="relative inline-block">
              <div
                className="w-64 h-64 sm:w-80 sm:h-80 mx-auto lg:mx-0 rounded-full p-1"
                style={{
                  background: `linear-gradient(to bottom right, ${theme.colors.primary}, ${theme.colors.secondary})`,
                }}
              >
                <div
                  className={`w-full h-full rounded-full flex items-center justify-center text-6xl ${theme.isDark ? "bg-gray-700" : "bg-gray-200"}`}
                >
                  <img
                    // src="./SSMB29.jpg"
                    src="./Ram.jpg"
